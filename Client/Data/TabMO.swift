...
//    }
    ...
    class func preserveTab(tab: Tab) {
...
//    class func savedTabData(tab: Tab, context: NSManagedObjectContext = DataController.shared.mainThreadContext, urlOverride: String? = nil) -> SavedTab? {
